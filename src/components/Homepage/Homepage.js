...
const Homepage = ({ repos }) => {
  ...
  return (
    ...
    <div className="relative " >
      ...
      <div className=""   >
     <div className="absolute bg-no-repeat "></div>
        ...
        {/*Main Col*/}
        <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-100 z-10 mx-6 lg:mx-0">
        ...
        {/*Img Col*/}
        <div className="w-full z-10 lg:w-2/5"  >
     ...
     <div className="absolute bg-no-repeat bg-cover bg-center h-full w-full z-0 left-0 top-0" style={{backgroundImage: 'url("wall.jpeg")'}}></div>
        ...
        <div className="py-36 ">
          <div className="mx-auto max-w-7xl  sm:px-6 lg:px-8">
            <div className="overflow-hidden bg-opacity-25  shadow-3xl bg-gray-800 sm:rounded-3xl">
              <div className="">
          ...
          <div className="min-h-screen -pt-4 flex flex-col lg:flex-row justify-around content-center  relative bg-no-repeat bg-cover bg-center " style={{backgroundImage: 'url("school.jpg")'}} id="Formation">
            <div data-aos="zoom-in-up " className="max-w-1/2 self-center bg-opacity-50 p-4 shadow-xl bg-gray-300 sm:rounded-3xl">
            ...
            <div className="self-center bg-opacity-50 p-4 shadow-xl bg-gray-300 sm:rounded-3xl">
