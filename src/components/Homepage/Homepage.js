...
const Homepage = ({ repos, Open, setOpen }) => {
    ...
    <div className="relative " >
      ...
      <div className=""   >
          ...
          <div className="container mx-auto max-w-4xl flex lg:pt-0 pt-44  items-center h-auto lg:h-screen flex-wrap mx-auto mb-32 lg:my-0"  >
            ...
            <div data-aos="fade-right" id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-100 z-10 mx-6 lg:mx-0">
              <div className="p-4  text-center lg:text-left">
                ...
                <p className="pt-2 text-md">Lorsque j'avais 14 ans j'ai réalisé des projets de petites envergures en HTML, PHP, Flash tels que le site internet d'une association d'airsoft dont je faisais partie ainsi que des pages web en HTML et PHP liées à une base de données servant à la création de compte pour accéder à un serveur de jeu que j'hébergeais. </p>
                <p className=" text-md">De là est née ma passion pour le développement web. Le destin a fait que je me suis orienté vers l'hôtellerie restauration, aimant aussi voyager j'ai, pendant un peu plus de 10 ans, travaillé dans divers pays tels que l'Angleterre', l'Ecosse, l'Australie.</p>
        ...
        <div className="min-h-screen -pt-4 flex flex-col lg:flex-row justify-around content-center  relative bg-no-repeat bg-cover bg-center " style={{ backgroundImage: 'url("school.jpg")' }} id="Formation">
          <div data-aos="zoom-out" className="lg:max-w-1/2 self-center bg-opacity-95 p-4 shadow-xl bg-white sm:rounded-3xl">
          ...
          <div data-aos="zoom-in" className="self-center bg-opacity-90 p-4 shadow-xl bg-white sm:rounded-3xl">
            <Image className=" shadow-xl " size="large" src="/logos/oclockandopqast.png"></Image>
          </div>
        ...
        <div className="bg-black" id="Contact">
          <div className="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
            ...
            <div className="p-5 w-48 ">
              ...
              <a className="my-3 block" href="/#">474200 Thonon-les-bains, France<span className="text-teal-600 text-xs p-1" /></a><a className="my-3 block" href="/#">luc.georges.ld@gmail.com <span className="text-teal-600 text-xs p-1" /></a>
            </div>
          </div>
        </div>
